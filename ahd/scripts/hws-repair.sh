...
if [ -n "$MISSING_TOOLS" ]; then
    ...
    echo_string "required to compile and load the HwsAHDCapture Linux driver."
    echo_string ""
...
if [ ! -d $KERNEL_BUILD ]; then
    ...
    echo_string "is required to build and load the HwsAHDCapture Linux driver."
    echo_string ""
...
MODULE_LOADED=`lsmod | grep HwsAHDCapture`
